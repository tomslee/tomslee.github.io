...
@fig-trips-per-hour shows the number of trips each hour during the day, for February 6 of each year. (I chose February 6 to match a report from the City of Toronto [@policyinnovationtransportationservices2021]). The overall drop in trip volume is clear, as is the particular drop around the peak commuter hours of 8-10am and 4-7pm. This is no surprise: in many big cities commuter traffic at rush hour has not recovered. The December 2022 data is not that different in this respect. I'll look for this year's February 6 data when the City of Chicago releases it, probably at the end of March.
...
In reports on Uber driver earnings, one of the big questions is how to evaluate driver costs. Gas, tolls, per-kilometre wear-and-tear and cleaning are common to all drivers, but should we include the other costs of car ownership? And what about insurance? There's a case to be made that casual drivers who already own a car for personal use would have to pay these costs anyway, so they should not count towards cost of work (for example, [@hyman2020]). But at least for full-time drivers, many of whom buy or lease a vehicle specifically for their gig work, these costs must be considered. That's how we came up with our figure of \$8 per hour for full-time driver income in Toronto in our recent report [@slee_tom_2023], which was written up in the Globe and Mail last week [@subramaniam_uber_2023].
