...
It's common knowledge that ant societies are amazing. Ants are simple creatures, which seem to have nothing in common with us sophisticated humans, yet somehow they grow crops and they herd animals for milk, (fungus and aphids or caterpillars, respectively). They build settlements that resemble our cities, with road networks, waste management systems, temperature control, and public health systems including the use of antibiotics.
