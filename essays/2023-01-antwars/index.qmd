...
References and sources for this essay can be found in the much longer companion piece, *War as a system in nature* ([SSRN](https://papers.ssrn.com/sol3/papers.cfm?abstract_id=4262518 "SSRN version of War as a System in Nature"), [personal site](/essays/2022-12-antwar/ "personal site")).
:::
...
![The rich territory of a successful colony draws ... destructive enemies. Raiders from a neighbouring weaver ant colony looking to expand their own empire...](weaver_ants_1.jpg){#fig-weaver-ants-1 width="70%"}
...
![Invaders are quickly spotted! The guard releases pheromones to alert the rest of the colony.](weaver_ants_2.jpg){#fig-weaver-ants-2 width="70%"}
...
![They stream out of the nest to defend their home...](weaver_ants_3.jpg){#fig-weaver-ants-3 width="70%"}
...
![If the home defences fail, the colony will be wiped out!](weaver_ants_4.jpg){#fig-weaver-ants-4 width="70%"}
...
![Some of the defenders deploy their most potent weapon. They squirt formic acid. The stinging liquid halts the invaders in their tracks.](weaver_ants_5.jpg){#fig-weaver-ants-5 width="70%"}
...
![Home and territory are secure once again. A colony may lose many workers in defence of its home, but their sacrifice helps safeguard the next generation.](weaver_ants_7.jpg){#fig-weaver-ants-7 width="70%"}
...
![Two leafcutter ants of the genus *Atta*. Credit: Kathy & sam from Beaverton OR, USA, CC BY 2.0 <https://creativecommons.org/licenses/by/2.0>, via Wikimedia Commons](Hitchiking_leafcutter_ant.jpg){#fig-leafcutter-ants width="70%"}
